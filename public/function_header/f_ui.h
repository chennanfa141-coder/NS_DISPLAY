...
#if 1
#define RCK_SET()    GPIO_setPin(GPIO_22)   // RCK = 1
#define RCK_CLR()    GPIO_clearPin(GPIO_22) // RCK = 0
#define RCK_READ()   GPIO_readPin(GPIO_22)  // 
#endif
//#define KEYSEL (GpioDataRegs.AIODAT.bit.AIO4)
#define KEYSEL_SET() GPIO_setPin(GPIOA, GPIO_PIN_19)
#define KEYSEL_CLR() GPIO_clearPin(GPIOA, GPIO_PIN_19)
#define KEYSEL_READ() GPIO_readPin(GPIOA, GPIO_PIN_19)
#else
